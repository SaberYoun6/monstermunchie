package edu.vcu.hauntingcarcasses.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hauntingcarcasses@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hauntingcarcasses API";

        private String description = "hauntingcarcasses API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "hauntingcarcasses";
